...
function Blog (){
    ...
    return (
        ...
        <div className="card-center width" style={{width: '40rem'}}>
            ...
            <div className="card-body color-grey">
                ...
                <p className="card-text">Google Text to Speech API known as the gTTS API. It converts text entered by the user, into audio which can be saved as a mp3 file.</p>
